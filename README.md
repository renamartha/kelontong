...
Penerapan AJAX memungkinkan terjadinya asynchronous programming antara browser dan server tanpa harus memuat ulang/refresh halaman web. Hal ini berarti AJAX dapat memproses tiap request yang diberikan ke server. Seperti misalnya async/await. Async/await memungkinkan untuk menulis kode asynchronous. Keyword async digunakan sebelum suatu fungsi untuk menandakan bahwa itu adalah fungsi asynchronous dan keyword await dalam fungsi async untuk menunggu hasil dari operasi asynchronous sebelum melanjutkan eksekusi kode.

### 4. Pada PBP kali ini, penerapan AJAX dilakukan dengan menggunakan Fetch API daripada library jQuery. Bandingkanlah kedua teknologi tersebut dan tuliskan pendapat kamu teknologi manakah yang lebih baik untuk digunakan.
Fetch API adalah bagian asli dari JavaScript yang dikenal sebagai alternatif yang lebih ringan dan fleksibel untuk mengelola permintaan HTTP dengan menggunakan Promise. Dalam pengembangan web modern, Fetch API  dianggap lebih efisien dan ringan karena memanfaatkan fitur JavaScript yang ada. Namun, terdapat kondisi di mana menggunakan jQuery tetap menjadi opsi yang valid, terutama jika proyek melibatkan integrasi yang luas dengan berbagai API atau jika seseorang lebih nyaman dengan pendekatan jQuery. Namun, dalam banyak kasus, Fetch API sering menjadi pilihan yang lebih efisien dan responsif dalam pengembangan web.
